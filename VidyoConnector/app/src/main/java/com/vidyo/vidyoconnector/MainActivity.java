...
public class MainActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEpicData = findViewById(R.id.epicDataTextBox);
    ...
    protected void onStart() {
        ...
        if (mRefreshSettings &&
            ...
            if(uri != null){
                String param = uri.getQueryParameter("portal");
                mPortal.setText(param!=null ? param : "https://epic.alpha.vidyo.com");

                param = uri.getQueryParameter("encryptedData");
                mEpicData.setText(param!=null ? param : "");
            }
            else{
                mPortal.setText(intent.hasExtra("portal")? intent.getStringExtra("portal") : "https://epic.alpha.vidyo.com");
                mEpicData.setText(intent.hasExtra("encryptedData") ? intent.getStringExtra("encryptedData") :  "");
            }
        }
    }
    ...
    public void toggleConnect() {
        if (mToggleConnectButton.isChecked()) {
            ...
            String displayName;
            String roomPin = "";
            String epicData = mEpicData.getEditableText().toString();
            String response;
    ...
    public class GetEpicdata extends AsyncTask<String, Void, String> {
